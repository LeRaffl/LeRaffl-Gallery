...
- **The uncertainty bands** → `R/bands.R` **and** `docs/architecture/44-uncertainty-bands.md` (the explanation end users and AIs rely on; re-check its §6 validation after any method change).
