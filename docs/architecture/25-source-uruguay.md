...
slug: uruguay
method: file
summary: New-registration data for Uruguay from ACAU's yearly Compilado workbook.
...
- Buses
variant_notes:
  Whole: AUTOS + SUV worksheets combined.
  Vans: UTILITARIO worksheet.
  HDV: CAMIONES worksheet.
  Buses: OMNIBUS worksheet.
hev_split: true
