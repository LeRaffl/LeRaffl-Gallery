...
- **Argentina** — `Pickups` (every new PICK-UP body type — simple, doble, cabina y media, carrozada; overwhelmingly N1, no weight field to confirm it)
