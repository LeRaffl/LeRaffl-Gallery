...
| Belgium | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Bulgaria | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
...
| Croatia | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Cyprus | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Czechia | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
...
| Estonia | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
...
| Greece | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Hungary | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Iceland | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
...
| Latvia | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Lithuania | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Luxembourg | New car registrations (VEHICLE_TYPE = CAR) | — | — | New van registrations (VEHICLE_TYPE = VAN) | Trucks + buses + road tractors combined | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report — Luxembourg's own STATEC source doesn't carry a separate Buses variant |
...
| Norway | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
...
| Romania | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Slovakia | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
| Slovenia | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
...
| Switzerland | New passenger-car registrations, via ACEA | — | — | New van registrations (N1, ≤ 3.5 t), via ACEA's annual Commercial Vehicle report | New truck registrations (N2+N3, > 3.5 t combined), via ACEA's annual Commercial Vehicle report — the BFS-direct legacy series (pxweb.bfs.admin.ch) mentioned in older docs was never built; this is the live one | New bus & coach registrations (M2+M3), via ACEA's annual Commercial Vehicle report |
...
> Czechia, Estonia, Greece, Hungary, Iceland, Latvia, Lithuania, Luxembourg's
> `Buses`, Norway, Romania, Slovakia, Slovenia, Switzerland) are **annual
> only** and, from ~2024 onward, report `BEV` as ACEA's combined
> "Electrically Chargeable Vehicle" bucket (BEV+PHEV together) — not a
> pure-BEV count. See [38-source-acea-cv.md](38-source-acea-cv.md) and
> `footnotes.csv`.
