...
| 33 | [33-expansion-candidates.md](33-expansion-candidates.md) | July-2026 expansion investigation: viable new-country candidates (Israel ✅ built, India, Morocco ❌ login-walled, South Africa ✅ built 2026-09) with sources, CI reachability probes and open verification points; shelved regions (Gulf, Jordan, Egypt, Sub-Saharan Africa minus SA); variant leads for existing countries (KBA/SMMT/SDES/OFV/Vahan 2W-3W). |
...
| 38 | [38-source-south-africa.md](38-source-south-africa.md) | Per-country source playbook for South Africa (naamsa Quarterly Review of Business Conditions). First African market. All-vehicle `Whole` (not M1); yearly 2020–2023 + quarterly from 2024-Q1; PHEV/HEV quarter-column swap repair. |
